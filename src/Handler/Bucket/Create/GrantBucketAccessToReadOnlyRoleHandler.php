...
final class GrantBucketAccessToReadOnlyRoleHandler extends BaseHandler
{
    ...
    public function __invoke(
        ...
        // 3. Check whether the current SA has the setIamPolicy permission on the listing.
        //    This determines whether KBC1 can grant subscriber access to other projects (sharing).
        ...
        return (new GrantBucketAccessToReadOnlyRoleResponse())
