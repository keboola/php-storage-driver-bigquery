...
| 19.1 | FULL      | NO              | YES          | NO                  | YES    | YES          | STAGING + FULL IMPORTER - no need for data mapping but casting yes, but source is SELECT
| 19.2 | FULL      | NO              | YES          | NO                  | YES    | NO           | FULL IMPORTER - no need for data mapping but casting yes
| 20.1 | FULL      | NO              | YES          | NO                  | NO     | YES          | STAGING + FULL IMPORTER - no need for data mapping but casting yes, but source is SELECT
| 20.2 | FULL      | NO              | YES          | NO                  | NO     | NO           | FULL IMPORTER - no need for data mapping but casting yes
...
| 31.1 | FULL      | YES             | NO           | NO                  | YES    | YES          | STAGING + FULL IMPORTER - because source is SELECT
| 31.2 | FULL      | YES             | NO           | NO                  | YES    | NO           | FULL IMPORTER
| 32.1 | FULL      | YES             | NO           | NO                  | NO     | YES          | STAGING + FULL IMPORTER - because source is SELECT
| 32.2 | FULL      | YES             | NO           | NO                  | NO     | NO           | FULL IMPORTER
