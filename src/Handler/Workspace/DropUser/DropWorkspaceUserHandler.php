...
namespace Keboola\StorageDriver\BigQuery\Handler\Workspace\DropUser;
...
final class DropWorkspaceUserHandler extends BaseHandler
{
     ...
     * @param DropWorkspaceUserCommand $command
     */
    public function __invoke(
        ...
        assert($command instanceof DropWorkspaceUserCommand);

        assert($runtimeOptions->getMeta() === null);

        // validate
        assert($command->getWorkspaceUserName() !== '', 'DropWorkspaceUserCommand.workspaceUserName is required');
        ...
        // get info about service account from credentials JSON
