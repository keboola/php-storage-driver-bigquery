...
//      check that the Project2 cannot access the table yet
        ...
        // simulate manual steps when user and admin of external dataset have to go to the analytic hub and manually add subscriber
        $targetCredentials = CredentialsHelper::getCredentialsArray($this->targetProjectCredentials);
        ...
        $binding[] = new Binding([
            ...
            'members' => ['serviceAccount:' . $targetCredentials['client_email']],
        ]);
